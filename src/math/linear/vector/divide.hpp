#ifndef math_library_linear_algebra__vector_aritmetic_divide_HPP_
 #define math_library_linear_algebra__vector_aritmetic_divide_HPP_

 // ::math::linear::vector::divide( result, left, right )
 // ::math::linear::vector::divide( left, right )
