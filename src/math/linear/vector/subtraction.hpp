#ifndef math_library_linear_algebra__vector_aritmetic_subtraction_HPP_
 #define math_library_linear_algebra__vector_aritmetic_subtraction_HPP_

 // ::math::linear::vector::subtraction( result, left, right )
 // ::math::linear::vector::subtraction( result, right )
