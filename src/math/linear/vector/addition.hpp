#ifndef math_library_linear_algebra__vector_aritmetic_addition_HPP_
 #define math_library_linear_algebra__vector_aritmetic_addition_HPP_

 // ::math::linear::vector::addition( result, left, right )
 // ::math::linear::vector::addition( result, right )
