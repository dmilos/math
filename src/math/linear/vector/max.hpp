#ifndef math_library_linear_algebra__vector_aritmetic_max_HPP_
 #define math_library_linear_algebra__vector_aritmetic_max_HPP_
     ...
     namespace vector
      {
          ...
          while( I_result != result_param.data() )
           {
             ...
             *I_result = std::max( *I_left,  *I_right );
           }
         }
       ...
       template< typename scalar_name >
        ...
        max
         ...
         {
          result_param[0] = left_param[0] < right_param[0] ? right_param[0] : left_param[0];
          result_param[1] = left_param[1] < right_param[1] ? right_param[1] : left_param[1];
         }
       ...
       template< typename scalar_name >
        ...
        max
         ...
         )
         {
          result_param[0] = left_param[0] < right_param[0] ? right_param[0] : left_param[0];
          result_param[1] = left_param[1] < right_param[1] ? right_param[1] : left_param[1];
          result_param[2] = left_param[2] < right_param[2] ? right_param[2] : left_param[2];
         }
       ...
       template< typename scalar_name >
        ...
        max
         ...
         )
         {
          ...
          result_param[1] = left_param[1] < right_param[1] ? right_param[1] : left_param[1];
          result_param[2] = left_param[2] < right_param[2] ? right_param[2] : left_param[2];
          result_param[3] = left_param[3] < right_param[3] ? right_param[3] : left_param[3];
         }
