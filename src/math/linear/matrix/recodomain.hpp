#ifndef Dh_math_linear_matrix_recodomain
 #define Dh_math_linear_matrix_recodomain

// ::math::linear::matrix::recodomain<scalar_name,dimension_number>( result, matrix, target, source )
