#ifndef Dh_math_linear_matrix_redomain
 #define Dh_math_linear_matrix_redomain

// ::math::linear::matrix::redomain<scalar_name,dimension_number>( result, matrix, target, source )
