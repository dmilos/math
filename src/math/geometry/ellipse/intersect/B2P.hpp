     ...
     namespace ellipse
      {
        ...
        struct B2P
         {
          public:
            ...
            typedef ::math::geometry::ellipse::base2D<scalar_name>             ellipse_type;
            ...
            static unsigned process
              ...
              )
             {
              ...
              transformed.origin()[0] = line.origin()[0] / ellipse.mayor();
              transformed.origin()[1] = line.origin()[1] / ellipse.minor();
       ...
       template
        ...
        unsigned intersect
         ...
         {
          return ::math::geometry::ellipse::B2P<scalar_name>::process( l1, l2, ellipse, line );
         }
