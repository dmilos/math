           ...
           class recenter
            {
             public:
               ...
               bool process( homography_type & h, interval_type const& window, scalar_name const& large = 2  )
                { // recenter so the image can occupy window space horizontal as much as possible
                 homogeneous_type O, V, X, Y;
                 math::linear::matrix::transform( O, h, { window[0][0], window[0][1], 1 } );
                 math::linear::matrix::transform( X, h, { window[0][0], window[0][1], 1 } );
                 math::linear::matrix::transform( Y, h, { window[0][0], window[1][1], 1 } );
                 math::linear::matrix::transform( V, h, { window[1][0], window[1][1], 1 } );

                 scalar_name width = window[1][0] - window[0][0];
                 ...
                 interval_type  target{   display_type{ window[0][0]         , window[0][1] },
                                          display_type{ window[1][0]         , window[1][1] } };
                 interval_type  codomain{ display_type{ window[0][0] + m_move, window[0][1] },
                                          display_type{ window[1][0] + m_move, window[1][1] } };
