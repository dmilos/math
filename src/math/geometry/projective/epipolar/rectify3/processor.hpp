          ...
          class processor
           {
            public:
              ...
              bool process( camera_type const& sinister, camera_type const& dexter, pbase_type & pbase )
               {
                m_rectificator.process( sinister.to_world(), dexter.to_world(), pbase );

                m_rectificator.left(  m_L/*, sinister, dexter*/ );
                ...
                m_rectificator.right( m_R/*, sinister, dexter*/ );
           ...
           private:
              ...
              typedef ::math::geometry::projective::epipolar::rectify3::projector<scalar_type>  projector_type;
