#ifndef math_geometry_projective_epipolar_rectify3_psbs
#define math_geometry_projective_epipolar_rectify3_psbs

// ::math::geometry::projective::epipolar::rectify3::psbs<double>.process(  left2world, right2world )
      ...
      namespace epipolar
       {
        ...
        template < typename scalar_name >
         class psbs    //!< for side by side cameras. This is true rectification
            ...
            bool process( affine_type const& left2world, affine_type const& right2world )
             {
              ...
              ::math::linear::vector::addition( up, m_leftNewUp, m_rightNewUp );    ::math::linear::vector::length<scalar_type>( up, 1 );
