...
int main( int argc, char *argv[] )
 {
  ...
  ::math::geometry::projective::camera::rectify( left, right, { { 1, 0, 0, 1 }, {   1,   0 } } );
  print( left, "left" ); print( right, "right" );

  ::math::geometry::projective::camera::rectify( left, right, { { 1, 0, 0, 1 }, { 100,   1 } } );
  print( left, "left" ); print( right, "right" );

  ::math::geometry::projective::camera::rectify( left, right, { { 1, 0, 0, 1 }, {   0,   1 } } );
  print( left, "left" ); print( right, "right" );

  ::math::geometry::projective::camera::rectify( left, right, { { 1, 0, 0, 1 }, {   1,   1 } } );
  print( left, "left" ); print( right, "right" );
