...
int main( int argc, char *argv[] )
 {
  ...
  ::math::linear::vector::structure<double, 2>  p1{ -0.1,  0.9 };

  ::math::geometry::direction::two<double, 2>            t_ref{ p0, p1 };     print(  t_ref );  std::cout << std::endl;
  ::math::geometry::direction::polar<double>            po_ref{ t_ref };      print( po_ref );  std::cout << std::endl;
  ::math::geometry::direction::parametric<double, 2>    pp_ref{ t_ref };      print( pp_ref );  std::cout << std::endl;
  ::math::geometry::direction::ABC2D<double>             a_ref{ t_ref };      print(  a_ref );  std::cout << std::endl;
  ::math::geometry::direction::normal<double>            n_ref{ t_ref };      print(  n_ref );  std::cout << std::endl;
  ...
  std::cout << "---------  two_type  --------" << std::endl;
   ...
   t = t_ref; print(  t ); std::cout << "  " << ::math::geometry::direction::distance( t, p0 ) << ", " << ::math::geometry::direction::distance( t, p1 ) << std::endl;
  ...
  a = t_ref; a.normalize();print(a);  std::cout << "  " << ::math::geometry::direction::distance(a, p0) << ", " << ::math::geometry::direction::distance(a, p1) << std::endl;
  ...
  std::cout << "----  polar_type  ---------" << std::endl;
   ...
   t = po_ref; print(   t );  std::cout << "  " << ::math::geometry::direction::distance( t, p0 ) << ", " << ::math::geometry::direction::distance( t, p1 ) << std::endl;
  ...
  pp = po_ref; print(  pp );  std::cout << "  " << ::math::geometry::direction::distance( pp, p0 ) << ", " << ::math::geometry::direction::distance(pp, p1 ) << std::endl;
   a = po_ref; a.normalize();print(   a );  std::cout << "  " << ::math::geometry::direction::distance( a,  p0 ) << ", " << ::math::geometry::direction::distance( a, p1 ) << std::endl;
   ...
   t  = pp_ref; print(  t );  std::cout << "  " << ::math::geometry::direction::distance( t, p0 ) << ", " << ::math::geometry::direction::distance( t, p1 ) << std::endl;
   ...
   a  = pp_ref; a.normalize();print(  a );  std::cout << "  " << ::math::geometry::direction::distance(  a,  p0 ) << ", " << ::math::geometry::direction::distance( a, p1 ) << std::endl;
   ...
   t  = a_ref; print(  t );  std::cout << "  " << ::math::geometry::direction::distance( t, p0 ) << ", " << ::math::geometry::direction::distance( t, p1 ) << std::endl;
   ...
   a  = a_ref; a.normalize();print(  a );  std::cout << "  " << ::math::geometry::direction::distance( a,  p0 ) << ", " << ::math::geometry::direction::distance( a, p1 ) << std::endl;
   ...
   t  = n_ref; print(  t );  std::cout << "  " << ::math::geometry::direction::distance( t, p0 ) << ", " << ::math::geometry::direction::distance( t, p1 ) << std::endl;
   ...
   a  = n_ref; a.normalize();print(  a );  std::cout << "  " << ::math::geometry::direction::distance( a,  p0 ) << ", " << ::math::geometry::direction::distance( a, p1 ) << std::endl;
